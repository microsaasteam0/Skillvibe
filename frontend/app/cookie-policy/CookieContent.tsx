                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-24">
                        <div className="inline-flex items-center gap-3 mb-10 px-6 py-2.5 bg-slate-100 dark:bg-slate-900/80 text-slate-900 dark:text-amber-500 rounded-xl text-[10px] font-black uppercase tracking-[0.4em] font-mono border border-slate-200 dark:border-slate-800 shadow-2xl relative overflow-hidden group">
                            ...
                            <span className="relative z-10">COOKIES_1.0</span>
                        </div>
                        <h1 className="text-5xl lg:text-8xl font-display font-black text-slate-900 dark:text-white mb-8 tracking-tighter uppercase leading-[0.85]">
                            Cookie <br /> <span className="text-amber-600 dark:text-amber-500 underline decoration-amber-500/20">Policy</span>
                        </h1>
                            ...
                            <div className="p-10 lg:p-14 space-y-16">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-slate-900 dark:text-white">Cookie Logic</h2>
                                    </div>
                                    <div className="text-slate-600 dark:text-slate-400 leading-relaxed font-bold text-[15px] space-y-6 max-w-3xl">
                                        <p>
                                            Cookies are small files saved in your browser. They help us keep you logged in and remember your preferences so the site works smoothly.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-slate-900 dark:text-white">Node Classification</h2>
                                    </div>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        {[
                                            { title: "Essential cookies", icon: Settings, desc: "Needed for login and basic site functions. You can’t turn these off without breaking the site." },
                                            { title: "Performance cookies", icon: Database, desc: "Help us see how the site is used so we can make it better." }
                                        ].map((item, i) => (
                                ...
                                <div className="space-y-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-slate-900 dark:text-white">External Sync</h2>
                                    </div>
                                    <div className="p-8 bg-slate-950 rounded-[2rem] border border-slate-800 relative overflow-hidden group">
                                        ...
                                        <div className="relative z-10 space-y-6">
                                            <p className="text-slate-400 text-[14px] font-bold leading-relaxed max-w-2xl">
                                                We work with a few trusted partners who may also set cookies when you use SkillVibe:
                                            </p>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h2 className="text-sm font-black uppercase tracking-[0.3em] text-slate-900 dark:text-white">Cookie Management</h2>
                                    </div>
                                    <div className="text-slate-600 dark:text-slate-400 leading-relaxed font-bold text-[15px] space-y-6 max-w-3xl">
                                        <p>
                                            You can delete cookies using your browser settings, but deleting essential cookies will make SkillVibe stop working properly.
                                        </p>
                                        <div className="p-6 bg-slate-50 dark:bg-slate-950/80 border-l-4 border-amber-600 rounded-r-2xl flex items-start gap-5">
                                            ...
                                            <p className="text-[12px] uppercase tracking-wide leading-relaxed font-black">
                                                TIP: Keep cookies enabled for the best experience.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="pt-16 border-t border-slate-200 dark:border-slate-800">
                                    <div className="flex flex-col md:flex-row items-center justify-between gap-10">
                                        <div className="text-center md:text-left">
                                            <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3 uppercase tracking-tighter">Technical Support</h3>
                                            <p className="text-slate-500 dark:text-slate-400 font-bold text-xs uppercase tracking-widest">Need help or have questions? Email us.</p>
                                        </div>
